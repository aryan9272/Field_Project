...
-- 4. Create the 'notifications' table (MISSING TABLE)
-- This table is required for the new notification logic in api.php
CREATE TABLE notifications (
    id INT AUTO_INCREMENT PRIMARY KEY,
    recipient_username VARCHAR(255) NOT NULL,
    message TEXT NOT NULL,
    item_id INT, -- This is the missing column required to link to the 'items' table
    is_read BOOLEAN DEFAULT 0,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    -- Ensure the recipient is a valid user and that the item_id references a valid item
